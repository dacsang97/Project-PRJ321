...
<html lang="en">
    ...
    <div class="wrapper">
        <div class="container" id="edit-lesson">
    ...
    <% 
        QuizBean bean = (QuizBean) request.getAttribute("quizs");
        List<Quiz> quizArr = bean.getQuizs();
        String quizStr = new Gson().toJson(quizArr);
        request.setAttribute("quizzes", quizStr);
    %>
    <script>
        const title = "${quizs.name}"
        const type = ${quizs.type}
        const lid = ${param.lid}
        const quizzes = ${quizzes}
    </script>
    <script src="./assets/js/page/edit-lesson.js"></script>
